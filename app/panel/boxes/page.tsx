  ...
  function rarityBadge(r: RarityRow) {
    ...
    switch (r.code) {
      case "COMMON":
        return (
          <span
            className={`${base} border-1 border-emerald-400/90 ring-1 ring-emerald-500/30 bg-emerald-900/30 text-emerald-100 shadow-[0_0_0_3px_rgba(16,185,129,.18)]`}
          >
            Common
          </span>
        );
      ...
      case "RARE":
        return (
          <span
            className={`${base} border-1 border-sky-400/90 ring-1 ring-sky-500/30 bg-sky-900/30 text-sky-100 shadow-[0_0_0_3px_rgba(56,189,248,.18)]`}
          >
            Rare
          </span>
        );
      ...
      case "EPIC":
        return (
          <span
            className={`${base} border-1 border-fuchsia-400/90 ring-1 ring-fuchsia-500/30 bg-purple-900/30 text-fuchsia-100 shadow-[0_0_0_3px_rgba(232,121,249,.18)]`}
          >
            Epic
          </span>
        );
      ...
      case "SUPREME":
        return (
          <span
            className={`${base} border-1 border-yellow-400/90 ring-1 ring-yellow-500/30 bg-amber-900/30 text-yellow-100 shadow-[0_0_0_3px_rgba(250,204,21,.18)]`}
          >
            Supreme
          </span>
        );
      ...
      case "LEGENDARY":
        return (
          <span
            className={`${base} border-1 border-rose-400/90 ring-1 ring-rose-500/30 bg-rose-900/30 text-rose-100 shadow-[0_0_0_3px_rgba(244,63,94,.18)]`}
          >
            Legendary
          </span>
        );
      ...
      default:
        return (
          <span className={`${base} border border-slate-500/50 bg-slate-800/60 text-slate-100`}>
            {r.name}
          </span>
        );
    }
